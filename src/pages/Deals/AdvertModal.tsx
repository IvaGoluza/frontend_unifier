      ...
      <ModalBodyContainer>
        {advert ? (
          <div className="grid grid-cols-1 min-[768px]:grid-cols-3">
            ...
            {advert.hasImage && !image && (
              <div
                className="order-2 col-span-1 mb-10 mt-0 h-96 w-10/12 justify-self-center rounded-xl sm:w-80 md:order-1
                md:ml-8 md:mt-16 lg:ml-12 lg:mt-10 xl:ml-12 xl:mt-16"
              ></div>
            )}
