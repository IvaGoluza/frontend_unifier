   ...
   return (
      <>
         <div className="purple-background">
            <div className="absolute top-20 circleXmark">
               <FontAwesomeIcon icon={faCircleXmark} style={{ color: "#ffffff", }} size="2x" />
            </div>
            <div className="absolute top-40 left-20 flex items-center justify-center">
               ...
               <div>
                  <div className="title-bar flex flex-auto">
                     <h1 className="title">OVO JE NAZIV ZAHTJEVA</h1>
                     <button className="request-state ml-20 pl-5 pr-5 mb-2 hover:bg-white">ARHIVIRAJ</button>
                  </div>
                  <div className="request-info flex">
                     <div className="request-info-item">{request.category}</div>
                     <div className="request-info-item">{request.helpType}</div>
                     <div className="request-info-item">Jendokratna akcija</div>
                     <div className="request-info-item">{request.town}</div>
                  </div>
               </div>
               <div className="request-info-data mt-5">
                  <div className="request-info-data-location">
                     <FontAwesomeIcon icon={faLocationDot} style={{ marginRight: '5px' }} />{request.location}
                  </div>
                  <div className="request-info-data-time mt-3">
                     <FontAwesomeIcon icon={faClock} style={{ marginRight: '5px' }} />{request.time}
                  </div>
                  <div className="request-info-data-number mt-3"># Broj potrebnih volontera: 6</div>
               </div>
            </div>
            <div className="description-requirements">
               <div>
                  ...
                  <div className="description-requirements-desc mr-20 w-80">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</div>
               </div>
               <div>
                  <div className="description-requirements-title">OPIS POTREBNE POMOĆI</div>
                  <div className="description-requirements-desc w-80">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</div>
               </div>
            </div>
